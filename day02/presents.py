def calc_required_paper(presents_dimensions):
    ...
    for present in presents_dimensions:
        ...
        side_a = int(dimensions[0]) * int(dimensions[1])
        side_b = int(dimensions[0]) * int(dimensions[2])
        side_c = int(dimensions[1]) * int(dimensions[2])
